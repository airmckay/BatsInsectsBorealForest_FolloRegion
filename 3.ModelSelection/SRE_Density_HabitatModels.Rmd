...
tab_model(PL4b.p3) # this explains 7% (marginal), conditional = 31% 
...
# #' for the GP GLM. We first obtain the scaled quantile residuals.
# 
E3.gp <- simulateResiduals(fittedModel = PL4b.p3, plot = FALSE)
...
predictions.p <- predict(PL4b.p3, type = "response", newdata = newdata.p, se.fit = TRUE)
beep()
