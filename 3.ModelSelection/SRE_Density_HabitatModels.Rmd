...
windows()
cowplot::plot_grid(pred.m, pred.p, pred.c, pred.f, nrow = 2, ncol = 2, labels = c("a.", "b.", "c.", "d."))
...
general<- ggplot(bats1 %>%
  ...
  geom_vline(xintercept = 172, linetype="longdash", 
                color = "#cc8400", size=1.5) +
  geom_vline(xintercept = 124, linetype="dotted", 
                color = "#ffb732", size=1.5) +
