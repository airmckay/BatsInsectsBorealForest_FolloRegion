...
```{r}
head(H65.21)
#   File        CanOpen   LAI Type            Site 
#   <chr>         <dbl> <dbl> <fct>           <fct>
# 1 FF01_IB.jpg  0.243   2.34 Interior Forest FF01 
# 2 FF01_OB.jpg  0.160   4.24 Open Forest     FF01 
# 3 FF02_IB.jpg  0.236   2.76 Interior Forest FF02 
# 4 FF02_OB.jpg  0.307   2.52 Open Forest     FF02 
# 5 FF03_IB.jpg  0.0940  4.45 Interior Forest FF03 
# 6 FF03_OB.jpg  0.253   2.88 Open Forest     FF03 

head(H65.22)
#   File        CanOpen    LAI Type            Site 
#   <chr>         <dbl>  <dbl> <fct>           <fct>
# 1 FF01_CB.jpg   0.165 Inf    Canopy Forest   FF01 
# 2 FF01_IB.jpg   0.146   3.72 Interior Forest FF01 
# 3 FF01_OB.jpg   0.273   4.80 Open Forest     FF01 
# 4 FF02_CB.jpg   0.225   4.41 Canopy Forest   FF02 
# 5 FF02_IB.jpg   0.175   3.70 Interior Forest FF02 
# 6 FF02_OB.jpg   0.358   3.42 Open Forest     FF02 
```
