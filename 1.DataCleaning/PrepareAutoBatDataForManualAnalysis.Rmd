...
# # 
# bats21 <- read_csv("C:/Users/apmc/OneDrive - Norwegian University of Life Sciences/3. Follo Forest 2021-2023/Manuscripts/Analyses/ForDryad/1.DataCleaning/AutoBatForManualAnalysis/Extraction FF21_AllFiles_troubleshooting_columns_included_SitePlot.csv", 
...
# # 
# # 
# bats22 <- read_csv("C:/Users/apmc/OneDrive - Norwegian University of Life Sciences/3. Follo Forest 2021-2023/Manuscripts/Analyses/ForDryad/1.DataCleaning/AutoBatForManualAnalysis/2022_AutomaticallyProcessed_BatAcousticData_allsitescombined_unedited.csv")
# # # 494268 obs
# # 
...
# 
# ## How many were SRE bats? and how much of this was nosie? 
# 
# sre22 <- b22_df2 %>% filter(autoid %in% 
...
FF <- read_csv("C:/Users/apmc/OneDrive - Norwegian University of Life Sciences/3. Follo Forest 2021-2023/Manuscripts/Analyses/ForDryad/1.DataCleaning/AutoBatForManualAnalysis/Simple_AllBatData.CSV",
...
## How much of this was SRE? 

sre <- FF %>% filter(autoid %in% 
                              c("MYOALC", "MYOBEC", "MYOBRA", "MYODAS",
                                "MYODAU", "MYOMYO", "MYOMYS", "MYONAT",
                                "BARBAR", "PLEAUR", "PLEAUS")) %>% 
  filter(Plot == "Open") %>% droplevels()

## 39,983 bat passes in open habitat. 
