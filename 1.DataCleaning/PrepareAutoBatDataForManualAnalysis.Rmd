...
- Manually ID all SRE bat passes (Myotis species, Plecotus species, Barbastelles),  then subset the rest of the data to include at least one file per taxon per site and per night (method found in this study: https://www.nature.com/articles/s41598-021-89660-z). 2500 NoID passes per plot type will also be analyzed. 
* Some of this analysis was done in 2022 and needs to be removed when subsetting to extract files for manual acoustic analysis. 
